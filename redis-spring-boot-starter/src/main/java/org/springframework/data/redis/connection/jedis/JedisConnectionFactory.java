 ...
 * @since 1.0.0
 */
public class JedisConnectionFactory  implements InitializingBean, DisposableBean, RedisConnectionFactory, JedisConnectionFactoryMBean {
    ...
    protected Pool<Jedis> createRedisPool() {
        return new EnhancedJedisPool(getPoolConfig(), getHostName(), getPort(), getConnectTimeout(), getReadTimeout(), getPassword(), getDatabase(), getClientName(), clientConfiguration);
    }
